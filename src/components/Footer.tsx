        ...
        <div className="grid md:grid-cols-2 gap-16 mb-20 border-b border-[#4A3933]/10 pb-20">
          <div>
            ...
            <form className="relative max-w-sm">
              <input 
                ...
                required
              />
              <button type="submit" className="absolute right-2 top-1/2 -translate-y-1/2 w-8 h-8 bg-nova-text rounded-full flex items-center justify-center text-white hover:bg-nova-text/80 transition-colors cursor-pointer">
          ...
          <div className="grid sm:grid-cols-2 gap-10">
            <div>
              ...
              <ul className="space-y-4 text-nova-text/70 font-light">
                <li>
                  <p className="font-semibold text-nova-text mb-1">{t.footer.downtown}</p>
                  <p>123 Sweet Street</p>
                  <p>City Center, 00-123</p>
                </li>
                <li className="pt-2">
                  <p className="font-semibold text-nova-text mb-1">{t.footer.kiosk}</p>
                  <p>45 River Walk</p>
            ...
            <div>
              ...
              <ul className="space-y-4 text-nova-text/70 font-light">
                <li>
                  <p className="font-semibold text-nova-text mb-1">Mon - Thu</p>
                  <p>10:00 AM - 9:00 PM</p>
                </li>
                <li className="pt-2">
                  <p className="font-semibold text-nova-text mb-1">Fri - Sun</p>
